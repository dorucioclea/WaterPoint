...
{
    public class ListCustomerJobsRunner : IListEntitiesRunner<PaginatedCustomerIdOrgId, JobWithCustomerAndStatusPoco>
    {
        private readonly IDapperDbContext _dapperDbContext;

        public ListCustomerJobsRunner(IDapperDbContext dapperDbContext)
        {
