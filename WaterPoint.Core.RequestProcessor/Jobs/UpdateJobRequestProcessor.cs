...
namespace WaterPoint.Core.RequestProcessor.Jobs
{
    public class UpdateJobRequestProcessor :
        ...
        IRequestProcessor<UpdateJobRequest, JobContract>
    {
        ...
        public JobContract Process(UpdateJobRequest input)
        {
        ...
        private JobContract ProcessDeFacto(UpdateJobRequest input)
        {
