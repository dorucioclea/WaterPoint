...
namespace WaterPoint.Api.CostItem.Controllers
{
    ...
    public class CostItemsController : BaseOrgnizationContextController
    {
        ...
        private readonly IDeleteRequestProcessor<BulkDeleteCostItemsRequest> _bulkDeleteRequestProcessor;
        ...
        [Route("")]
        public IHttpActionResult Delete([FromUri]BulkDeleteCostItemsRequest request)
        {
